...
public class ShipCreator{
    ...
    public static ShipModel CreateShip(string name, int starIndex, int parentIndex, Orbit orbit, IdentityModel owner, CreatureModel captain)
    {
        ...
        shipModel.workers = 0;
        shipModel.parentIndex = parentIndex;
        shipModel.name = name;
        shipModel.dateCreated = new Dated(GameManager.instance.data.date.time);
        shipModel.lastUpdated = new Dated(GameManager.instance.data.date.time);
