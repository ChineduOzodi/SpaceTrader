...
////// Emissive:
                ...
                float node_6670_ang = 3.141592654;
                ...
                float node_1351 = (node_6670*float2(1.0,_GradientScale)).g;
                return fixed4(finalColor,(lerp(lerp((node_5552_if_leA*node_9237)+(node_5552_if_leB*node_9237),float3(node_1351,node_1351,node_1351),node_5552_if_leA*node_5552_if_leB),float3(0,0,0),_Transparency).r*i.vertexColor.a));
            }
            ENDCG
        }
    }
